...
import type { GameVoteConfig, VoteOption, VoteQuestion } from '../types/config.js';
...
const VOTE_SETTINGS_TEAMER: readonly VoteQuestion[] = [
  ...
  // Reuse map options from FFA to keep config consistent.
...
function draftModeQuestion(gameType: DraftGameType): VoteQuestion {
